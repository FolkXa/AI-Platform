...
class OpenRouterAIServiceImpl(AIServiceInterface):
    ...
    def make_streaming_api_request(self, messages: List[dict], max_tokens: int = 1000):
        """Public method to make streaming API requests (not supported by OpenRouter client)"""
        # For OpenRouter, we'll return a generator that yields the full response
        # This maintains compatibility but doesn't provide true streaming
